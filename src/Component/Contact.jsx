    ...
    <div>
      <div id="box-search">
        <div className="w-100" style={{ position: "relative" }}>
          <img
            alt="img_alt_text"
            style={{ width: "100%" }}
            src={process.env.PUBLIC_URL + "/image/offerta vacan.png"}
          />
              ...
              <div className="card-body p-2 br-none mh-200 ">
                ...
                >
                  <img
                    alt="img_alt_text"
                    className="m-2"
                    src={process.env.PUBLIC_URL + "/icons/contact-mail 1.png"}
                  />
                </div>
            ...
            <div className="card text-center m-2">
              <div className="card-body ">
                ...
                <div className="input-group mb-3">
                  <input
                    type="text"
                    className="form-control bSize br-none"
                    placeholder="Name"
                    aria-label="Username"
                ...
                <div className="d-grid gap-2 pt-2 pb-3">
                  <button className="btn pbcolor bSize br-none" type="button">
                    Button
                  </button>
                </div>
              </div>
              ...
              <div className="card-body ">
                ...
                <ul className="text-color listynone">
                  <li className="text-left">
                    Any kind of business solution and consultion don't hesitate
                    to contact with us for imiditate customer support. We are
      ...
      <div className="container">
        <img
          alt="img_alt_text"
          className="img-fluid "
          src={process.env.PUBLIC_URL + "/image/image 20.png"}
        />
      </div>
