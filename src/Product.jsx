...
const Product = () => {
  return (
    ...
    //     <div  style={{color:"#003756" , background: "#F5F5F5"
    //         }}>
    //             <h1 className='text-left  p-2' >Torre del mar</h1>
    //             <div className='text-left  p-2' style={{
    ...
    //   <ProductCard/>
    //   <hr /> <h1 className='p-2'>Related offers
    //     </h1>
    ...
    // <p> da <a href="" className='text-color f-6'> € 5.146,50</a> </p>
    ...
    <div className="bg-inconme">
      ...
      <div className="p-4 text-color bg-inconme">
        <h1 className="text-left  p-2">Torre del mar</h1>
          ...
          <tbody className="table-group-divider">
            <tr className="b-none">
              <td className="align-middle border-right col-sm-3">
                {" "}
                <div className="">
                  <h6>CAMERA VISTA MARE LATERALE</h6> <h6>V73</h6>
                </div>
              </td>
              <td className="border-right">
                <div className="row ">
      ...
      <div className="container">
        {" "}
        <h1 className="p-2">Related offers</h1>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris tortor
          odio, laoreet ut rutrum ac, interdum et ligula. Morbi ornare viverra
          varius. Suspendisse blandit, nisl at auctor bibendum, urna justo
          malesuada nulla, eu dapibus odio diam eu tellus.
        </p>
        <div className="row">
          <div className="col-sm-4">
            <div className="card text-color br-alblu" style={{ width: "" }}>
              ...
              <p className="text-left  px-3">
                Un Ambiente Intimo E Rilassato, Dove Lo Sguardo, Dalla Piscina,
                Può Spaziare Fino All’orizzonte Libero Da Costrizioni; Allo
                Stesso Tempo, Fuori Da Quest’oasi, Si Dipana La Movida Di Ibiza
                E Di Playa D’en Bossa.{" "}
              </p>
              <button
                type="button"
          ...
          <div className="col-sm-4">
            <div className="card text-color br-alblu" style={{ width: "vh" }}>
              ...
              <hr className=" bt-2" />
              <p className="text-left  px-3">
                Lussuoso Hotel In Ottima Posizione Per Vivere A Pieno Playa De
                Palma, A Meno Di 50 Metri Dalla Lunghissima Spiaggia Di Sabbia E
                Dall’animato Lungomare. La Struttura È Caratterizzata Da
                Luminosità...{" "}
              </p>
              <button
                type="button"
          ...
          <div className="col-sm-4">
            <div className="card text-color br-alblu" style={{ width: "" }}>
              ...
              <hr className=" bt-2" />
              <p className="text-left  px-3">
                Gli Appartamenti Baia De Bahas Sono Degli Appartamenti Situati
                Nel Golfo Di Marinella, A 300m Dalla Spiaggia, 3km Da Porto
                Rotondo E 14km Da Olbia. Babysitting, Noleggio Bici E Moto ...{" "}
              </p>
              <button
                type="button"
                className="btn btn-primary br-none pbcolor m-2 p-2"
